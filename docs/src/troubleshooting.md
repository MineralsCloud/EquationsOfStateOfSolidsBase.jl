...
[discuss with us](https://github.com/MineralsCloud/EquationsOfStateOfSolidsBase.jl/discussions).

If you have additional tips, please either
[report an issue](https://github.com/MineralsCloud/EquationsOfStateOfSolidsBase.jl/issues/new) or
[submit a PR](https://github.com/MineralsCloud/EquationsOfStateOfSolidsBase.jl/compare) with suggestions.
...
## Loading EquationsOfStateOfSolidsBase
